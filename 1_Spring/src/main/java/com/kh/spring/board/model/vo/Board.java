...
public class Board {
	...
	public Board(int boardId, String boardTitle, String boardWriter, String nickName, String boardContent,
			String originalFileName, String renameFileName, int boardCount, Date boardCreateDate,
			Date boardModifyDate, String boardStatus) {
		super();
	...
	public String toString() {
		return "Board [boardId=" + boardId + ", boardTitle=" + boardTitle + ", boardWriter=" + boardWriter
				...
				+ ", renameFileName=" + renameFileName + ", boardCount=" + boardCount
